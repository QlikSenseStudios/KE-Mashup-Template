...
require(["js/qlik"], function(qlik) {
  ...
  app.getList("SelectionObject", function(reply) {
    ...
    console.log(reply.qSelectionObject);
	console.log(reply.qSelectionObject.qSelections);
	 var selectionsObject1 = reply.qSelectionObject.qSelections.length;
    ...
    if (totalSelections == 0) {
      ...
      $(".notification .badge").show().html(selectionsObject1);
    }
	...
	$('[data-control]').click(function(){
		var $element = $(this);
		switch ($element.data('control')) {                    ////we are targeting that element using jquery
			case 'clear':
				app.clearAll()
